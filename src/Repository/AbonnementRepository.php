...
//    }
    ...
    public function findWithoutCoachOrNutri(): array
    {
        return $this->createQueryBuilder('a')
            ->andWhere('a.coach IS NULL OR a.nutri IS NULL')
            ->getQuery()
            ->getResult();
    }

    public function findAbonnementsExpires(): array
    {
        return $this->createQueryBuilder('a')
            ->andWhere('a.expirationDate < :now')
    ...
    {
        return $this->createQueryBuilder('a')
            ->andWhere('a.expirationDate = :date')
